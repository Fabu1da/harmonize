...
def print_triple_comparison_summary(summary: Dict):
    ...
    print(f"   All Matchers Correct: {overall['all_correct_rate']:.1%}")
    print(f"   TWO THIRD Matchers Correct:   {overall['two_correct_rate']:.1%}")
    print(f"   ONE THIRD Matchers Correct:   {overall['one_correct_rate']:.1%}")
    print(f"   ZERO Matchers Correct:   {overall['none_correct_rate']:.1%}")
